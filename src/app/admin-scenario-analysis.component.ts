...
@Component({
    selector: "app-admin-scenario-analysis",
    templateUrl: "./admin-scenario-analysis.component.html",
    styleUrls: ["./admin-scenario-analysis.component.css"],
...
export class AdminScenarioAnalysisComponent {
